...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    private Vector3 lastInteractnDir;
    ...
    private void HandleInteractions()
    {
        ...
        {
            lastInteractnDir = moveDir;
        }
        float interactDistance = 2f;
        if (Physics.Raycast(transform.position, lastInteractnDir, out RaycastHit raycastHit, interactDistance, countersLayerMask))
        {
