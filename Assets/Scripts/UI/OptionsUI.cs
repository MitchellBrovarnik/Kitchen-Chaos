...
public class OptionsUI : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        interactAltText.text = GameInput.Instance.GetBindingsText(GameInput.Binding.Interact_Alternate);
        ...
        gamepadInteractAltText.text = GameInput.Instance.GetBindingsText(GameInput.Binding.Gamepad_InteractAlternate);
